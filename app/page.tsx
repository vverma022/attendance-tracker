  ...
  return (
    ...
    <header className="px-4 lg:px-6 h-14 flex items-center justify-end">
      <nav className="flex gap-4 sm:gap-6">
        <Link className="text-sm hover:underline underline-offset-4" href="#features">
          Features
        </Link>
        <Link className="text-sm hover:underline underline-offset-4" href="https://github.com/vverma022/attendance-tracker">
          GitHub
        </Link>
      </nav>
    </header>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="space-x-4">
              ...
              <Link href="https://github.com/stack-auth/stack-template">
        ...
        <div className="container px-4 md:px-6">
          ...
          <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-xl font-normal">Next.js 14</CardTitle>
                </CardHeader>
                <CardContent>
    ...
    <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full items-center px-4 md:px-6 border-t justify-center">
